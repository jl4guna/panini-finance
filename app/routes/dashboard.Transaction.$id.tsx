...
import { getTransaction, updateTransaction } from "~/models/dashboard/Transaction.server";
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-3">
              ...
              <div className="relative mt-2">
                <input type="text" id="description" name="description" defaultValue={ transaction?.description || ""}
                  className={ getClassName(Boolean(errors?.description)) } required={ true } />
                {errors?.description ? (
            ...
            <div className="sm:col-span-3">
              ...
              <div className="relative mt-2">
                <input type="number" id="amount" name="amount" defaultValue={ transaction?.amount || ""}
                  className={ getClassName(Boolean(errors?.amount)) } required={ true } />
                {errors?.amount ? (
                <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                  <ExclamationCircleIcon className="h-5 w-5 text-red-500" aria-hidden="true" />
                </div>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="relative mt-2">
                <input type="datetime-local" id="date" name="date" defaultValue={ transaction?.date || ""}
                  className={ getClassName(Boolean(errors?.date)) } required={ true } />
                {errors?.date ? (
                <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                  <ExclamationCircleIcon className="h-5 w-5 text-red-500" aria-hidden="true" />
                </div>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="relative mt-2">
                <select id="userId" name="userId" defaultValue={ transaction?.userId }
